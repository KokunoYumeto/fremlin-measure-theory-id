...
EXPECTED_TARGET_SHA256 = "f66fe29627b477079f5f4bfe815936db827941c637eb7e096dc90d8992a1da30"
...
def main() -> int:
    ...
    if sha256_bytes(target_bytes) != EXPECTED_TARGET_SHA256 or len(target_bytes) != 28141:
