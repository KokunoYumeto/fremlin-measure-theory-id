...
EXPECTED_STRUCTURAL_QA_SHA256 = "0580383c01bb6b0ffe109663e238e28508761cbedcff65093cbf9509380a99eb"
EXPECTED_SEMANTIC_REVIEW_SHA256 = "8319046053de3bfa5f9b4ce1f1d2ef23ff8067695b1e59bab46306f52a2eef29"
...
def validate_catalog(catalog_sets) -> dict[str, object]:
    ...
    if correction_resource.get("rows") != 16:
...
def validate_historical_preservation() -> dict[str, object]:
    ...
    if sha256(old_catalog_manifest) != "3c233dfd969256524fbd267c9ab3c581798807d4bceb57e296d731c23acbd3c6":
...
def validate_authority_target_and_receipts() -> dict[str, object]:
    ...
    if len(target_bytes) != 44853 or sha256_bytes(target_bytes) != EXPECTED_TARGET_SHA256:
    ...
    if len(correction_rows) != 16:
        raise ValueError("correction ledger must contain exactly sixteen cumulative rows")
    ...
    return {
        ...
        "target": {"path": TARGET_PATH.relative_to(ROOT).as_posix(), "bytes": 44853, "sha256": EXPECTED_TARGET_SHA256, "lines": 1055},
        ...
        "correction_ledger": {"path": "00_control/SOURCE_CORRECTIONS.csv", "bytes": CORRECTIONS_PATH.stat().st_size, "sha256": EXPECTED_CORRECTIONS_SHA256, "rows": 16},
        "receipts": {
