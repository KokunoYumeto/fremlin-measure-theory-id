#!/usr/bin/env python3
"""Replay the complete 59-route through-Chapter-24 offline reader in Chromium.
...
READER = ROOT / "output" / "fondasi-teori-ukuran-v1-through-chapter24-id" / "html"
BUILD_RECEIPT = ROOT / "qa" / "through-chapter24-html-build.json"
RECEIPT = ROOT / "qa" / "through-chapter24-html-browser-qa.json"
...
def validate_static_tree() -> tuple[dict[str, Any], list[dict[str, Any]], dict[str, Any]]:
    ...
    require(len(EXPECTED_ROUTES) == 59, "internal expected route count differs")
    ...
    require(build.get("checks", {}).get("routes") == 59, "build receipt route count differs")
    require(build.get("coverage", {}).get("official_pages_complete") == 305,
...
def build_receipt() -> dict[str, Any]:
    ...
    return {
        "schema": "o007-volume1-through-volume2-chapter24-html-browser-qa-v1",
        ...
        "scope": {
            ...
            "official_source_page_accounting": "305 of 672 (Volume I 102 + Volume II pages 1-203)",
            "html_routes_in_materialized_tree": 59,
        },
        "inputs": {
        ...
        "coverage": {
            "routes": list(EXPECTED_ROUTES),
            "unique_current_routes_with_desktop_and_mobile_evidence": 59,
            "route_viewport_observations": 118,
        ...
        "checks": {
            ...
            "all_59_routes_exercised_at_desktop_and_mobile": True,
        ...
        "next_gate": (
            ...
            "Chapter 24 admission, deterministic release package, and publication."
        ),
    }
