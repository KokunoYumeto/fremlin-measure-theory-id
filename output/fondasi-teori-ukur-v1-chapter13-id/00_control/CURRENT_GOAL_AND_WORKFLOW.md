...
Status: production active; Sections 111–115 and 121–122 admitted; Section 123
is the active source-order cursor
...
through `mt115.tex` and `mt121.tex`–`mt122.tex`, including all prose, results,
proofs, notes, 101 exercises, 30 typed hints, references, the accessible S121
footnote, and the four Section 113 diagrams. `CP0007_MT122_ADMISSION.md`
supplies the fail-closed backend/reader/visual predicate for the exact S122
target hash. The active source-order cursor is `O007-FREMLIN-V1-S123`, complete
`mt123.tex`; no Indonesian S123 target is yet claimed. No `mt116.tex` exists in
