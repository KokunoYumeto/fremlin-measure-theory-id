...
def validate_corrections(unit_sets, source: str, target: str) -> dict[str, object]:
    ...
    return {
        ...
        "ledger": {"path": "00_control/SOURCE_CORRECTIONS.csv", "bytes": CORRECTIONS_PATH.stat().st_size, "sha256": sha256(CORRECTIONS_PATH), "total_rows": 12},
...
def validate_catalog(catalog_sets) -> dict[str, object]:
    ...
    if resources["O007-RESOURCE-SOURCE-CORRECTIONS"].get("rows") != 12:
...
def validate_authority_and_target() -> dict[str, object]:
    ...
    return {
        ...
        "correction_ledger": {"path": "00_control/SOURCE_CORRECTIONS.csv", "bytes": CORRECTIONS_PATH.stat().st_size, "sha256": EXPECTED_CORRECTIONS_SHA256},
