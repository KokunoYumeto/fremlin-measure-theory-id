...
tak-negatif dengan ` $\infty$ ' ditambahkan. Saya menduga Anda telah
...
berhingga, maka\cmmnt{, karena semuanya tak-negatif,} barisan jumlah
...
karena setiap $h(x)$ tak-negatif. \cmmnt{(Pada awalnya Anda mungkin
...
ukuran pada $Y$. ($\nu$ disebut {\bf ukuran bayangan} pada $Y$, dan
