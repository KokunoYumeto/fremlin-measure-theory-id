...
EXPECTED_STRUCTURAL_SHA256 = "813963f43cd07657a18af18ce10afd743fa9e50c8dad1b8f06423d8f55eb6349"
EXPECTED_SEMANTIC_SHA256 = "2e63f64ac8f143e1e4455598693f7c50efa3876d5146088f8277b427ebde1133"
...
def build_catalog(
    ...
    catalog["resources"].extend([
        {
            ...
            "verification_status": "seventeen rows including one S123 correction; formula ordinal 262 linked and verified 2026-08-22",
    ...
    if len(correction_rows) != 1 or correction_total_rows != 17:
        raise ValueError("catalog construction requires one S123 and seventeen cumulative correction rows")
    if {name: len(records) for name, records in catalog.items()} != {
