...
EXPECTED_CORRECTIONS_SHA256 = "1ad72e853a4044ae10f090a281c33e30ee6c1ff1fb9cb25b5e02bc8b817e5de8"
...
def build_catalog_s122(source_bytes: bytes, target_bytes: bytes, source: str, target: str, correction_rows):
    ...
    catalog["resources"].extend([
        {
            ...
            "verification_status": "sixteen rows including four S122 corrections; formula ordinals 95 and 256 linked and verified 2026-08-22",
    ...
    if len(correction_rows) != 4 or correction_total_rows != 16:
        raise ValueError("catalog construction requires four S122 and sixteen cumulative correction rows")
    return catalog
...
def build_catalog(source_bytes: bytes, target_bytes: bytes, source: str, target: str, correction_rows):
    ...
    catalog["resources"].extend([
        {
            ...
            "verification_status": "twelve rows including five S121 corrections; six S121 formula deltas linked to five correction records and verified 2026-08-22",
            "provenance": provenance(
                "correction-evidence",
    ...
    if len(correction_rows) != 5 or correction_total_rows != 12:
        raise ValueError("catalog construction requires five S121 and twelve cumulative correction rows")
    return catalog
...
EXPECTED_TARGET_SHA256 = "898783f7dc36acb07721f891525c215a53788ae7974dacd27590f51449b847f7"
EXPECTED_TARGET_BYTES = 44853
EXPECTED_TARGET_LINES = 1055
EXPECTED_CORRECTIONS_SHA256 = "81643efa989dc2b00ea078629fb24f9cda2fa3e8b643ffc999b58909448f99c5"
EXPECTED_INTAKE_SHA256 = "41f9c6df14ec64ff7f58a961320e2fabec03da3152425fdd586c6521db091ca1"
EXPECTED_STRUCTURAL_SHA256 = "0580383c01bb6b0ffe109663e238e28508761cbedcff65093cbf9509380a99eb"
EXPECTED_SOURCE_REVIEW_SHA256 = "8319046053de3bfa5f9b4ce1f1d2ef23ff8067695b1e59bab46306f52a2eef29"
EXPECTED_CORRECTION_IDS = [
...
TARGET_LABELS = {
    ...
    "122K": "Integral fungsi tak-negatif", "122L": "Sifat U dan integralnya",
...
DEFINITION_SPECS = [
    ...
    ("NONNEGATIVE-INTEGRAL", "122K", "integral of a nonnegative function in U", "integral fungsi tak-negatif dalam U"),
...
RESULT_LABELS = {
    ...
    "122J": ("Equivalent constructions of the nonnegative integral", "Konstruksi ekuivalen integral tak-negatif"),
...
TERM_SPECS = [
    ...
    ("NONNEGATIVE-FUNCTION", "non-negative function", "fungsi tak-negatif", "preferred", ["NONNEGATIVE-INTEGRAL"]),
