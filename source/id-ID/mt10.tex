...
\Centerline{\it Edisi pertama Mei 2000}

\Centerline{\it Edisi kedua Januari 2011}
...
\centerline{\twentybf Jilid 1}

\bigskip\bigskip

\centerline{\twentyrm Minimum yang Tak Tereduksi}
...
\centerline{\fourteenit Profesor Riset Matematika, University of
Essex}
...
\noindent Pertama kali diterbitkan pada tahun 2000
...
Pendahuluan Umum \pagereference{6}{6}
...
\noindent{\bf Pendahuluan Umum}

\medskip

Dalam risalah ini saya bermaksud memberikan
...
pengetahuan terperinci yang agak terbatas.   Penekanan di seluruh karya ini
terletak pada gagasan-gagasan matematika yang terlibat, yang dalam bidang ini
sebagian besar terdapat dalam rincian pembuktian.
...
Karena itu, yang saya lakukan adalah menuliskan keduanya (dalam
\S\S114-115), sehingga pada pembacaan pertama Anda dapat melewati dimensi
yang lebih tinggi (dengan mengabaikan \S115), sekaligus memperoleh argumen
yang lengkap dan tidak berbelit untuk dimensi tersebut (jika Anda mengabaikan
Bagian \S114).
...
Jilid 5 akan mengandaikan penguasaan luas atas banyak bagian analisis dan
teori himpunan.
...
sebuah paragraf dari mana pun paragraf itu dirujuk.   Dengan demikian, 132E adalah
paragraf kelima dalam bagian kedua Bab 13, yang merupakan
bab ketiga jilid ini, dan dirujuk dengan nama itu
di seluruh karya.
...
perintah, atau bahkan anjuran, untuk kembali ke \S121.
Jika Anda merasa puas dengan argumen sebagaimana adanya,
...
Secara khusus, saya ingin menyebut F.Nazarov dan P.Wallace Thompson, yang melalui 
pembacaan menyeluruh atas jilid ini telah memperbaiki banyak kekeliruan.

\wheader{{\it Pendahuluan Jilid 1}}{18}{6}{6}{100pt}

\noindent{\bf Pendahuluan Jilid 1}
...
\noindent{\bf Catatan tentang cetakan kedua dan ketiga}

\medskip

Untuk cetakan kedua jilid ini saya membuat beberapa koreksi, disertai
beberapa latihan baru.   Untuk cetakan ketiga saya melakukan hal yang sama;
selain itu, saya menambahkan satu hasil elementer dan definisi formal
untuk beberapa istilah yang hampir baku.   Dalam dua kasus, saya juga
memperkenankan diri menata ulang sekumpulan latihan dalam urutan yang kini
tampak lebih alami bagi saya.

\bigskip

\noindent{\bf Catatan tentang edisi kedua, 2011}

\medskip

Untuk edisi baru (`Lulu') jilid ini, saya telah memperbaiki sejumlah
kesalahan lain;  tidak diragukan lagi masih banyak yang tersisa.   Ada beberapa
latihan tambahan, dan sedikit lebih banyak materi tentang integral atas dan
bawah (\S133).
