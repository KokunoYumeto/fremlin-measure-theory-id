...
sederhana tak-negatif, sehingga $\int g-f\ge 0$, menurut 122Cc; tetapi hal ini berarti
bahwa
$\int g-\int f\ge 0$.
...
fungsi sederhana tak-negatif sedemikian sehingga
...
tak-negatif sedemikian sehingga $f\eae\lim_{n\to\infty}f_n$ dan
...
\noindent Maka $f_n$ merupakan fungsi sederhana tak-negatif, karena
...
$\langle g_n\rangle_{n\in\Bbb N}$ dari fungsi sederhana tak-negatif
...
$\langle f_n\rangle_{n\in\Bbb N}$ dari fungsi sederhana tak-negatif
...
$f_2$ fungsi sederhana tak-negatif (jika $f=\sum_{i=0}^na_i\chi
...
terhadap perkalian dengan skalar tak-negatif (122Lb), dan
...
(a) Suatu fungsi bernilai real tak-negatif, yang didefinisikan pada subhimpunan $X$,
...
terintegralkan
dan tak-negatif, sehingga integralnya tak-negatif, dan
...
fungsi tak-negatif (122H-122L); (iii) integrasi fungsi bernilai real yang
umum (122M-122R). Saya menempuh setiap tahap secara perlahan; misalnya,
saya baru beralih ke fungsi tak-negatif yang terintegralkan setelah
...
fungsi tak-negatif yang terintegralkan, lalu untuk fungsi terintegralkan
...
kriteria yang sangat berguna bagi keterintegralan fungsi tak-negatif
(lihat 122Ra).
