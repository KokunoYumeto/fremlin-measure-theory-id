...
EXPECTED_CORRECTIONS_SHA256 = "27d6e1a53de6b6f1e37a6d1a41c3d202d7cd6c2a21897d0399ba215364ced967"
...
def validate_corrections(unit_sets, source: str, target: str) -> dict[str, object]:
    ...
    return {
        ...
        "ledger": {"path": "00_control/SOURCE_CORRECTIONS.csv", "bytes": CORRECTIONS_PATH.stat().st_size, "sha256": sha256(CORRECTIONS_PATH), "total_rows": 7},
...
def validate_catalog(catalog_sets) -> dict[str, object]:
    ...
    if resources["O007-RESOURCE-SOURCE-CORRECTIONS"].get("rows") != 7:
